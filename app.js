...
function startAnimation() {
    if (!animationExecuted) {
        setTimeout(() => {
            ...
            revealElements('.home-img, .skills-container, .training-container h3, .training-container h4, .training-box p, .training-icon i, training-icon p, .experience-container h3, .experience-container h4, .experience-box p, .experience-icon i, experience-icon p, .projects-box, .contact form', 'bottom');
